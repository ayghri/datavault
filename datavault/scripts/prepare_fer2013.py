...
Usage:
    python scripts/prepare_fer2013.py --input /path/to/fer2013.csv --output /path/to/fer2013

This splits fer2013.csv into train_split.csv (Usage=Training) and
...
def main():
    ...
    parser.add_argument("--input", type=str, required=True, help="Path to fer2013.csv")
